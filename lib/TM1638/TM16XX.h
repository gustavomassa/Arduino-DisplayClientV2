...
class TM16XX
{
  ...
  protected:
	...
	virtual void o_data_digitalWrite(uint8_t val);
	virtual void o_clock_digitalWrite(uint8_t val);
	virtual void o_strobe_digitalWrite(uint8_t val);
	virtual void o_digitalWrite(uint8_t pin, uint8_t val);
	...
	uint8_t dataPin_bit;
	volatile uint8_t *dataPin_out;
	
	uint8_t clockPin_bit;
	volatile uint8_t *clockPin_out;
	
	uint8_t strobePin_bit;
	volatile uint8_t *strobePin_out;
};
