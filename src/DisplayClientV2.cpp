...
#define DEVICE_NAME "ShakeIt Motors"							//{"Group":"General","Name":"DEVICE_NAME","Title":"Device name,\r\n make sure to use a unique name when using multiple arduinos","DefaultValue":"SimHub Dash","Type":"string","Template":"#define DEVICE_NAME \"{0}\""}
#define DEVICE_UNIQUE_ID "9e0aa21b-01db-4e26-9b3d-b1d9b0ff90a4" //{"UniqueId":"9e0aa21b-01db-4e26-9b3d-b1d9b0ff90a4","Name":"DEVICE_UNIQUE_ID","Type":"uniqueid"}
